...
setup(
    ...
    name="fucked_up_scheduler",  # Required
    ...
    version=app.__version__,  # Required
    ...
    url="https://github.com/comov/fucked-up_schedule",  # Optional
    # This should be your name or the name of the organization which owns the
    # project.
    author="Comov",  # Optional
    ...
    install_requires=[
        ...
        "parso==0.7.0; python_version >= '2.7' and python_version not in '3.0, 3.1, 3.2, 3.3'",
